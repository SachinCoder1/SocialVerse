...
use serde::Serialize;
use socialverse_domain::ids::PollChoiceId;
use socialverse_domain::ids::PostId;
use socialverse_domain::ids::UserId;

use socialverse_endpoint::post::types::VoteCast;
use uuid::Uuid;
...
impl Post {
    pub fn new(
        posted_by: UserId,
        content: socialverse_endpoint::post::types::Content,
        options: socialverse_endpoint::post::types::NewPostOptions,
...
pub fn new(conn: &mut PgConnection, post: Post) -> Result<PostId, DieselError> {
    conn.transaction::<PostId, DieselError, _>(|conn| {
        use socialverse_endpoint::post::types::Content as EndpointContent;
...
pub mod tests {
    ...
    use socialverse_endpoint::post::types::NewPostOptions;
    use util as test_post;
    pub mod util {
        use socialverse_domain::post::Message;
        use socialverse_endpoint::post::types::{Chat, Content};
